...
<body>
  ...
  <div id='face'>
    ...
    <div id="face2">
      ...
      <?php 
        if($_POST['btn']){
          $margin='1px';
          $link='http://localhost/autorecrute/actualite.php';
           include('scriptes/creer.php');
        }else if($_POST['connecter']){
          $href='http://localhost/autorecrute/actualite.php';
  ...
  <a href='http://localhost/autorecrute/actualite.php'><img src='images/ss.png' style='cursor:pointer;margin-right:30;margin-top:-117px; width:50; float:right;'/></a></br>
