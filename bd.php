...
<body>
    ...
    <div id='face'>
        ...
        if (empty($_POST['nom']) || empty($_POST['prenom']) || empty($_POST['pays']) || empty($_POST['adr']) || empty($_POST['ville']) || empty($_POST['postal']) || empty($_POST['tele1']) || empty($_POST['mobilite']) || empty($_POST['activite']) || empty($_POST['metierre']) || empty($_POST['disp']) || empty($_POST['condition'])) {
            ...
            echo '<p style="color:red; font-size:33px;"><i class="material-icons">close</i>Error</p></br>
            ...
            $req = mysqli_query($conn, "INSERT INTO formulaire (id,nom,prenom,annee,mois,jour,pays,adresse,ville,postal,telephone1,telephone2,mobilite,activite,metieractuel,metierrecherche,disponiblite) 
            VALUES (null,'$nom','$prenom','$annee','$mois','$jour','$pays','$adr','$ville','$tele1','$postal','$tele2','$mobilite','$activite','$metierac','$metierre','$disp')");
