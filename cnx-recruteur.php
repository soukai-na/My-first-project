      ...
      <div id='face2'>
        ...
        if (isset($mail) && isset($passwd)) {
          ...
          if (!$sql) {
            ...
            echo "<form method=POST action='cnx-recruteur.php' onsubmit='return validate()' name='myform'>
            ...
            echo "<div class=icon ><i class='material-icons'>account_circle</i><p style='font-size:37;margin-bottom:0px;    font-family: sans-serif;
                                  font-weight: 900;'>" . $_SESSION['prenom'] . " " . $_SESSION['nom'] . "
                                  </br><a href='donnees-recruteurs.php' style='font-size: 20px;color: #e6333c;text-decoration: none;'>>Mes données personnelles</a>
                                  </p></br><a href=deconnexion-recruteur.php ><button>Deconnexion</button></a></div>";
          }
        }
        if ($_POST['button']) {
          echo "<div class=icon ><i class='material-icons'>account_circle</i><p style='font-size:37;margin-bottom:0px;    font-family: sans-serif;
