...
<body>
<header>
  <?php $color2='#d7dae1'; include('scriptes/menu.php'); ?>
  ...
  <div id='face1'>
      <div id='sous'>
        <div style='font-weight:100; font-size:13; margin:auto; margin-top:50px;'>
          <a href='http://localhost/autorecrute/autorecrute.php'>Acceuil</a> > Emploi automobile
        </div>
      </div>
      ...
      <?php
        ...
        $sql=mysqli_fetch_array($result);
      ?>
      <font color='#555555' size='5px' face='arial'><?php echo $sql['titre']; ?></font>
      <div class='famille'>
         <?php echo $sql['buttons']; ?>
      </div>
  </div>
