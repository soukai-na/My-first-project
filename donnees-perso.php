    ...
    <div id='face'>
        ...
        <div id='face1' style='border: 3px black solid;width: 553px;'>
            ...
            <div class=formulaire style='display:block;'>
                Prénom<input type='text' name='prenom' value='' style='margin-left:86px;'></br>
                Nom<input type='text' name='nom' value='' style='margin-left:103px;'></br>
                <div style='display:flex;'><span>Date de naissance</span>
                    <select name='jour' value=5>
                    ...
                    <select name='annee' style='margin-left:5;' value=2014>
                ...
                E-mail<input type='text' name='email' value='' style='margin-left:95;'></br>
                Adresse<input type='text' name='adresse' value='' style='margin-left:88;'></br>
                Ville<input type='text' name='ville' value='' style='margin-left:107px;'></br>
                Code postal<input type='text' name='postal' value='' style='margin-left:65;'></br>
                Téléphone 1<input type='text' name='tele1' value='' style='margin-left:60;'></br>
                Téléphone 2<input type='text' name='tele2' value='' style='margin-left:60;'></br>
                Fonction souhaitée<select name='metierre' style='margin-left: 22px;' value=''>
                ...
                Disponibilité<select style='margin-left:59;'>
                ...
                </br> Mobilité géographique<select name=mobilite value=''>
                ...
                <input type='checkbox' name='offre' style='margin-left:14;' checked='checked' value='' />Je souhaite recevoir occasionnellement par email les offres d'emploi en rapport avec mon secteur d'activité ?</br>
